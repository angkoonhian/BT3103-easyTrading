            ...
            <v-card color ='grey lighten-4'>
                <v-card-text>
                    ...
                    <v-row no-gutters>
                        <v-col md="6">
                            <v-card color ='grey lighten-4'>
                                <v-img height="600" :width="600" v-bind:src="x[1].images[0]"></v-img>
                            </v-card>
                        </v-col>
                        <v-col md="6">
                            <v-card color ='grey lighten-4'>
                                ...
                                <v-card-text class=text-left>
                                    <p>
                                        <strong>Options:</strong> ${{ x[1]["Price"] }}
                                    </p>
                                    <p>
                                        <strong>Transaction method:</strong> {{ x[1]["sale"]["Transaction method"] }}
                                    </p>
                                    <p>
                                        <strong>Description:</strong> {{ x[1]["Description"] }}
                                    </p>
                                    <p>
                                        <strong>Alternatives:</strong> {{ x[1]["sale"]["Alternatives"] }}
                                    </p>
                                    <p>
